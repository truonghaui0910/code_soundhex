                    ...
                    <div className="max-w-4xl">
                        ...
                        <div className="flex flex-wrap gap-3 sm:gap-4 mt-8 justify-center">
                            <Button
                                ...
                                className={`min-w-0 flex-shrink-0 ${currentView === "overview" ? "bg-white text-purple-600 shadow-lg hover:bg-gray-50 hover:shadow-xl" : "bg-white/20 text-white hover:bg-white/30 border border-white/20"} transition-all duration-200`}
                            >
                            ...
                            <Button
                                ...
                                className={`min-w-0 flex-shrink-0 ${currentView === "analytics" ? "bg-white text-purple-600 shadow-lg hover:bg-gray-50 hover:shadow-xl" : "bg-white/20 text-white hover:bg-white/30 border border-white/20"} transition-all duration-200`}
                            >
                            ...
                            <Button
                                ...
                                className={`min-w-0 flex-shrink-0 ${currentView === "agreements" ? "bg-white text-purple-600 shadow-lg hover:bg-gray-50 hover:shadow-xl" : "bg-white/20 text-white hover:bg-white/30 border border-white/20"} transition-all duration-200`}
                            >
