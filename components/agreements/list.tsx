...
export default function AgreementsList() {
  ...
  const getStatusInfo = (status: string) => {
    switch (status.toLowerCase()) {
      case 'completed':
        return { 
          color: 'bg-green-100 text-green-800 border-green-200 dark:bg-green-900/30 dark:text-green-400 dark:border-green-700',
          icon: CheckCircle
        };
      case 'pending':
        return { 
          color: 'bg-yellow-100 text-yellow-800 border-yellow-200 dark:bg-yellow-900/30 dark:text-yellow-400 dark:border-yellow-700',
          icon: Clock
        };
      case 'declined':
        return { 
          color: 'bg-red-100 text-red-800 border-red-200 dark:bg-red-900/30 dark:text-red-400 dark:border-red-700',
          icon: XCircle
        };
      default:
        return { 
        ...
        <div className="relative container mx-auto px-6 py-16">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl mb-8 text-purple-100">
              Manage and track your legal agreements • Digital signatures • Document control
            </p>
            ...
            <Card className="border-0 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Total Agreements</p>
                    <p className="text-3xl font-bold text-gray-900 dark:text-white">{agreements.length}</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-green-600">
                      {agreements.filter(a => a.status.toLowerCase() === 'completed').length}
                    </p>
                  </div>
            ...
            <CardContent>
              {isLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No agreements found</h3>
                  <p className="text-gray-500 dark:text-gray-400 mb-6">Create your first agreement to get started.</p>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {agreements.map((agreement) => {
                        ...
                        return (
                          <TableRow key={agreement.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
              ...
              <div className="space-y-6 py-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Badge className={getStatusInfo(selectedAgreement.status).color}>
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-3">Submitters</h3>
                  <div className="space-y-3">
                    {selectedAgreement.submitters.map((submitter) => {
                      const statusInfo = getStatusInfo(submitter.status);
                      const StatusIcon = statusInfo.icon;
                      return (
                        <div key={submitter.id} className="border rounded-lg p-4 bg-gray-50 dark:bg-gray-800/50">
                          ...
                          <div className="text-sm text-gray-500 dark:text-gray-400 space-y-1">
                            ...
                            {submitter.completed_at && (
                              <div>Completed: {formatDate(submitter.completed_at)}</div>
                            )}
                          </div>
